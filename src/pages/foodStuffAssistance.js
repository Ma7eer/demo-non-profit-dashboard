...
import foodStuffAssistanceSchema from '../schemas/foodStuffAssistance'
...
const manifest = {
  schema: foodStuffAssistanceSchema,
  path: 'foodStuffAssistance',
  title: 'بيانات مساعدات مواد غذائية للأسر',
  columns: [
    {
      Header: '	الهاتف',
      accessor: 'phoneOfRecipient'
    },
    {
      Header: '	اسم المستلم',
    ...
    {
      Header: '	تاريخ بدء المساعدة',
      accessor: 'startDate'
    },
    {
      Header: '	اسم مركز التسوق',
      accessor: 'shoppingCenter'
    },
    {
      Header: '	رقم المساعدة',
...
export default class FoodStuffAssistance extends Component {
  constructor(props) {
    super(props)
    this.state = {
      schema: {},
